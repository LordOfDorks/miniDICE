#ifndef _DICE_CRYPTO_AES128_H
#define _DICE_CRYPTO_AES128_H
/******************************************************************************
...
//
void Dice_AES128_Enable(const uint8_t *key, aes128EncryptKey_t *aes128EncryptKey);

//
// Disable AES freeing any resources that were allocated
//
void Dice_AES128_Disable(aes128EncryptKey_t *aes128EncryptKey);

//
// AES counter mode encryption/decryption. Note that in
// CTR mode encryption is its own inverse. This function uses the key
// schedule created by Dice_AES128_Enable()
//
