#ifndef _DICE_CRYPTO_ECC_H
#define _DICE_CRYPTO_ECC_H
/******************************************************************************
...
//          - DICE_ERR_SECURITY otherwise
//
DICE_STATUS Dice_GenerateDHKeyPair(ecc_publickey *publicKey, ecc_privatekey *privateKey);
...
//          - DICE_ERR_SECURITY otherwise
//
DICE_STATUS Dice_GenerateShareSecret(ecc_publickey *peerPublicKey,
...
//          - DICE_ERR_SECURITY otherwise
//
DICE_STATUS Dice_GenerateDSAKeyPair(ecc_publickey *publicKey, ecc_privatekey *privateKey);
...
//          - DICE_ERR_SECURITY otherwise
//
DICE_STATUS Dice_DSASignDigest(const uint8_t *digest, const ecc_privatekey *signingPrivateKey, ecc_signature *sig);
...
//          - DICE_ERR_SECURITY otherwise
//
DICE_STATUS Dice_DSASign(const uint8_t *buf, uint16_t len, const ecc_privatekey *signingPrivateKey, ecc_signature *sig);
...
//          - DICE_ERR_SECURITY otherwise
//
DICE_STATUS Dice_DSAVerifyDigest(const uint8_t *digest, const ecc_signature *sig, const ecc_publickey *pubKey);
...
//          - DICE_ERR_SECURITY otherwise
//
DICE_STATUS Dice_DSAVerify(const uint8_t *buf, uint16_t len, const ecc_signature *sig, const ecc_publickey *pubKey);
