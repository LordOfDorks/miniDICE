...
void Dice_AES128_Enable(const uint8_t *key, aes128EncryptKey_t *aesEncryptKey)
{
    int i;
...
void Dice_AES128_Disable(aes128EncryptKey_t *aesEncryptionKey)
{
    MEMSET_BZERO(aesEncryptionKey, 0, sizeof(aes128EncryptKey_t));
}

#if AES_CTR_MODE
void Dice_AES_CTR_128(const aes128EncryptKey_t *aes128EncryptKey, const uint8_t *in,
...
#if AES_CBC_MODE
void Dice_AES_CBC_128_Encrypt(const aes128EncryptKey_t *aes128EncryptKey,
...
#if AES_ECB_MODE
void Dice_AES_ECB_128_Encrypt(const aes128EncryptKey_t *aes128EncryptKey,
