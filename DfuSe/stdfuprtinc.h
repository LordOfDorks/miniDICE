...
extern "C" DWORD PASCAL STDFUPRT_CreateMappingFromDevice(PCHAR szDevLink, PMAPPING *ppMapping, PDWORD pNbAlternates);
extern "C" DWORD PASCAL STDFUPRT_DestroyMapping(PMAPPING *ppMapping);

extern "C" DWORD PASCAL STDFUPRT_LaunchOperation(PDFUThreadContext pContext, PDWORD pOperation);
extern "C" DWORD PASCAL STDFUPRT_GetOperationStatus(DWORD OperationCode, PDFUThreadContext pContext);
extern "C" DWORD PASCAL STDFUPRT_StopOperation(DWORD OperationCode, PDFUThreadContext pLastContext);
